...
class UnCss {
   ...
   * @param {string} [options.targetDir] - Name of directory where files will be output
   ...
   * @param {string} [options.reportName = amp_uncss_report] - Report filename
   * @param callback
   ...
   */
  _initializeReport() {
    this.fullReportPath = this.options.reportDir + '/' + this.options.reportName;
