...
const typeZeroOptimizer = require('./type-zero-optimizations'),
    typeOneOptimizer = require('./type-one-optimizations'),
    AmpFile = require('./amp-file'),
    defaultConfigs = require('../utils/default-options');
...
class AmpUncss {
   ...
   * @param options - describes operating options for this use of AmpUncss
   * @param callback
   * @return {AmpUncss}
   */
