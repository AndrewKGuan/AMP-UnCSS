...
const tags = require('../utils/tags'),
    DomParser = require("../main/dom-parser"),
    CheerioInterface = require('../interfaces/cheerio-interface'),
    PuppeteerInterface = require('../interfaces/puppeteer-interface');
