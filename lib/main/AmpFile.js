...
class AmpFile {
   ...
   * @TODO Code review try-catch block here
   */
  _prepFile() {
    try {
  ...
  _extractFileData(data) {
     ...
     * @type {Set<string> | *}
     */
    this.attributeSelectors = data.attributeSelectors;
     ...
     * @type {Set<string> | *}
     */
    this.classSelectors = data.classSelectors;
     ...
     * @type {Set<string> | *}
     */
    this.elementSelectors = data.elementSelectors;
     ...
     * @type {Set<Object>}
     */
    this.emptySelectors = data.emptySelectors;
     ...
     * @type {Set<string>}
     */
    this.idSelectors = data.idSelectors;
     ...
     * @type {Set<string>}
     */
    this.nestedSelectors = data.nestedSelectors;
  ...
  writeData(targetDirectory, filenameDecorator) {
    ...
    const decorator = filenameDecorator ? `_${filenameDecorator}` : '';
  ...
  _failWithErrorMsg(msg) {
    this._stats.status = 'failed';
    this._stats.error = msg;
  }
}
