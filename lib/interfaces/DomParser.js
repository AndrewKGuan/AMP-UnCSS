...
const DomParser = {
   ...
   * @return {Promise<{dom: (* | jQuery | HTMLElement), ampElementSelectors: Set<any>, attributeSelectors: Set<any>, classSelectors: Set<any>, elementSelectors: Set<any>, emptySelectors: Set<any>, idSelectors: Set<any>, nestedSelectors: Set<any>}>}
   */
  extractDom: async function(fileName){
    const $ =  await this.buildDomFromFile(fileName);
  ...
  buildDomFromFile: async function(fileName) {
    /**
     *
     * @type {Buffer}
     */
