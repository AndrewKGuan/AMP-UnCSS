...
const DomParser = {
  ...
  extractDomData: function(fileName){
    ...
    /**
     *
     * @type {*|{ampElementSelectors: Set<string>, attributeSelectors: Set<string>, classSelectors: Set<string>, elementSelectors: Set<string>, emptySelectors: Set<Object>, idSelectors: Set<string>, joinedRawCss: string, nestedSelectors: Set<string>}}
     */
